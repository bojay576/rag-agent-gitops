...
MILVUS_HELM_VALUES=(
  ...
  --set minio.image.registry=swr.cn-north-4.myhuaweicloud.com
  --set minio.image.repository=ddn-k8s/quay.io/minio/minio
  ...
  --set etcd.image.repository=swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/milvusdb/etcd
